 ...
 * Implements a singleton connection pattern with reconnect support.
 */
...
/**
 * Connect to MongoDB. Reuses existing connection if already established.
 * @returns {Promise<mongoose.Connection>}
 */
async function connectDB() {
  // Reuse any existing mongoose connection
...
/**
 * Health check — returns connection ready state
 * @returns {number} readyState (0=disconnected, 1=connected, 2=connecting, 3=disconnecting)
 */
